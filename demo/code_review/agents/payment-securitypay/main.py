#!/usr/bin/env python3
"""SecurityPay Payment Agent - Main entry point."""
...
from agent import SecurityPayAgent
...
async def main():
    """Start the SecurityPay payment agent server."""
    # Load configuration
    ...
    # Create agent
    agent = SecurityPayAgent(config=config)
    ...
    logger.info(f"Payment processor ready - PREMIUM rewards on security work!")
