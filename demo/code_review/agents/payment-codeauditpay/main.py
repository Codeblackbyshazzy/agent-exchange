#!/usr/bin/env python3
"""CodeAuditPay Payment Agent - Main entry point."""
...
from agent import CodeAuditPayAgent
...
async def main():
    """Start the CodeAuditPay payment agent server."""
    # Load configuration
    ...
    # Create agent
    agent = CodeAuditPayAgent(config=config)
    ...
    logger.info(f"Payment provider ready - GET CASHBACK on code audits!")
