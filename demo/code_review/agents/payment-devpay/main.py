#!/usr/bin/env python3
"""DevPay Payment Agent - Main entry point."""
...
async def main():
    """Start the DevPay payment agent server."""
    # Load configuration
    ...
    # Create agent
    agent = DevPayAgent(config=config)
    ...
    logger.info(f"Payment processor ready - affordable dev payments!")
